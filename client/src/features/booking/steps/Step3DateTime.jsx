    ...
    <div className="space-y-12">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-5 gap-2 sm:gap-3">
          {["09:00 AM", "09:30 AM", "10:00 AM", "10:30 AM", "11:00 AM", "11:30 AM", "12:00 PM", "01:30 PM", "02:00 PM", "02:30 PM", "03:00 PM", "03:30 PM", "04:00 PM", "04:30 PM", "05:00 PM", "05:30 PM"].map(time => (
            <button
              key={time}
              onClick={() => onSelectTime(time)}
              className={`py-3 px-3 sm:py-4 sm:px-5 rounded-xl border text-[11px] sm:text-sm font-bold transition-all text-center flex justify-center items-center gap-1.5 group ${
                selectedTime === time 
            ...
            >
              <span>{time}</span>
              {selectedTime === time && <Check size={11} strokeWidth={3} />}
            </button>
          ))}
        </div>
      </div>
